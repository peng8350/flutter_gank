...
class SliverImageHeader extends SingleChildRenderObjectWidget{
  ...
  @override
  void updateRenderObject(BuildContext context, _RenderSliverImageHeader renderObject) {
...
class _RenderSliverImageHeader extends RenderSliverToBoxAdapter{
  _RenderSliverImageHeader({this.hiddenHeight,RenderBox child}) :super(child:child);
   double hiddenHeight;
